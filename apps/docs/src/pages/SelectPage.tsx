...
const options = [{ label: 'Apple', value: 'apple' }, { label: 'Orange', value: 'orange' }, { label: 'Disabled', value: 'disabled', disabled: true }]

export function SelectPage() {
  return (
    <>
      <h1>Select</h1>
      <DemoBlock title="Basic" code={`<Select placeholder="Select fruit" options={[{ label: 'Apple', value: 'apple' }]} />`}>
      ...
      <DemoBlock title="Form integration" code={`<Form.Item name="fruit"><Select options={options} /></Form.Item>`}>
