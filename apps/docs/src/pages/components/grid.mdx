...
export const blockStyle = 'rounded bg-blue-50 p-4 text-center text-blue-700'
export const strongBlockStyle = 'rounded bg-blue-200 p-4 text-center text-blue-900'

export const rowRows = [
  {
    property: 'gutter',
