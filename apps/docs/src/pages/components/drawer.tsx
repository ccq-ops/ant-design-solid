...
const drawerRows: ApiTableRow[] = [
  ...
  {
    property: 'width',
    description: 'Drawer width for left and right placements.',
    type: 'number | string',
  },
  {
    property: 'height',
    description: 'Drawer height for top and bottom placements.',
    type: 'number | string',
  },
  {
    property: 'closable',
  ...
  },
  {
    ...
    description: 'Allows closing by clicking the mask wrapper.',
    type: 'boolean',
    defaultValue: 'true',
  },
  {
  ...
  },
  {
    ...
    description: 'Unmounts children after close.',
    type: 'boolean',
    defaultValue: 'false',
  },
  ...
  {
    property: 'onClose',
    description: 'Called when the drawer requests close.',
    type: '() => void',
  },
  {
