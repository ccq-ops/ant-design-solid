...
**Goal:** Add a production-ready `Collapse` component to `@ant-design-solid/core` with tests, styles, package exports, and docs.
...
**Tech Stack:** SolidJS, TypeScript, Vitest, `@solidjs/testing-library`, `@ant-design-solid/cssinjs`, repository token/config-provider utilities.
...
```bash
COREPACK_ENABLE_DOWNLOAD_PROMPT=0 corepack pnpm --filter @ant-design-solid/core test -- collapse
```
