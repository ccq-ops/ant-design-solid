...
export function Switch(props: SwitchProps) {
  const [local, rest] = splitProps(props, ['checked', 'defaultChecked', 'disabled', 'loading', 'size', 'checkedChildren', 'unCheckedChildren', 'prefixCls', 'class', 'style', 'onChange', 'onBlur'])
  ...
  return (
    ...
    >
      <span class={`${prefixCls()}-inner`}>{checked() ? local.checkedChildren : local.unCheckedChildren}</span>
    </button>
  )
}
