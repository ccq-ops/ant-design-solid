...
export function useTableStyle(prefixCls: string) {
  ...
  return useStyleRegister({ theme: 'default', token: token(), path: ['Table', prefixCls] }, () => {
    ...
    return {
      ...
      [`.${prefixCls}-selection-header`]: {
        position: 'relative',
        display: 'inline-flex',
        'align-items': 'center',
        gap: 4,
      },
      [`.${prefixCls}-selection-menu`]: {
        position: 'relative',
        display: 'inline-flex',
      },
      [`.${prefixCls}-selection-menu-trigger`]: {
        display: 'inline-flex',
        'align-items': 'center',
        'justify-content': 'center',
        width: 18,
      ...
      [`.${prefixCls}-selection-menu-dropdown`]: {
        position: 'absolute',
        top: '100%',
        left: 0,
        'z-index': 1,
      ...
      [`.${prefixCls}-selection-menu-dropdown button`]: {
        display: 'block',
        width: '100%',
        padding: '5px 12px',
        border: 0,
      ...
      [`.${prefixCls}-selection-menu-dropdown button:hover`]: {
