...
const StyleContext = createContext<StyleContextValue>({ cache: defaultCache, hashPriority: () => 'low' })
...
export function useStyleContext(): StyleContextValue { return useContext(StyleContext) }
