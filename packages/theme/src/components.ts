...
export function getComponentToken<K extends keyof ComponentTokenMap>(
  ...
  const defaults: ComponentTokenMap = {
    ...
    Button: {
      ...
      defaultGhostColor: token.colorTextLightSolid,
      ghostBg: 'transparent',
      defaultGhostBorderColor: token.colorTextLightSolid,
    ...
    Radio: {
      radioSize: token.fontSizeLG,
      size: token.fontSizeLG,
      dotSize: token.fontSizeLG - (4 + token.lineWidth) * 2,
    ...
    Message: {
      ...
      contentPadding: `${token.paddingXS + 1}px ${token.paddingSM}px`,
    ...
    Modal: {
      ...
      contentPadding: token.paddingContentHorizontalLG,
      headerPadding: token.paddingContentHorizontalLG,
      headerBorderBottom: `${token.lineWidth}px ${token.lineType} ${token.colorSplit}`,
      headerMarginBottom: token.marginXS,
      bodyPadding: token.paddingContentHorizontalLG,
      footerPadding: token.paddingMD,
      footerBorderTop: `${token.lineWidth}px ${token.lineType} ${token.colorSplit}`,
      footerBorderRadius: `0 0 ${token.borderRadiusLG}px ${token.borderRadiusLG}px`,
      footerMarginTop: token.marginSM,
      confirmBodyPadding: `${token.paddingLG}px ${token.paddingLG}px 0`,
      confirmIconMarginInlineEnd: token.marginSM,
      confirmBtnsMarginTop: token.marginSM,
    },
    Drawer: {
      zIndexPopup: 1000,
    ...
    Badge: {
      ...
      indicatorHeight: Math.round(token.fontSize * token.lineHeight) - 2 * token.lineWidth,
      indicatorHeightSM: token.fontSize,
      overflowIndicatorHeight: Math.round(token.fontSize * token.lineHeight) - 2 * token.lineWidth,
      overflowIndicatorHeightSm: token.fontSize,
      dotSize: token.fontSizeSM / 2,
      ...
      statusSize: token.fontSizeSM / 2,
      paddingInline: token.paddingXS,
      badgeRibbonOffset: token.marginXS,
